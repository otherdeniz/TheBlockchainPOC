...
using TheBlockchainDB.Networks.Rules;
...
using TheBlockchainDB.Networks.Deployments;

namespace TheBlockchainDB.Networks
{
   public class TheBlockchainDBMain : Network
   {
      public TheBlockchainDBMain()
      {
         CoinSetup setup = TheBlockchainDBSetup.Instance.Setup;
         NetworkSetup network = TheBlockchainDBSetup.Instance.Main;

         NetworkType = NetworkType.Mainnet;
         DefaultConfigFilename = setup.ConfigFileName; // The default name used for the TheBlockchainDB configuration file.
         ...
         var bip9Deployments = new TheBlockchainDBBIP9Deployments()
         {
            [TheBlockchainDBBIP9Deployments.ColdStaking] = new BIP9DeploymentsParameters("ColdStaking", 2,
         ...
         Consensus.PosEmptyCoinbase = TheBlockchainDBSetup.Instance.IsPoSv3();
         Consensus.PosUseTimeFieldInKernalHash = TheBlockchainDBSetup.Instance.IsPoSv3();
      ...
      protected void RegisterRules(IConsensus consensus)
      {
         consensus.ConsensusRules
             ...
             .Register<TheBlockchainDBHeaderVersionRule>()
