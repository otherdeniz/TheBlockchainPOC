...
namespace TheBlockchainDB.Networks.Deployments
{
   /// <summary>
   /// BIP9 deployments for the Blockcore sample coin network.
   /// </summary>
   public class TheBlockchainDBBIP9Deployments : BIP9DeploymentsArray
   {
      ...
      /// </summary>
      public TheBlockchainDBBIP9Deployments() : base(NumberOfDeployments)
      {
      }
