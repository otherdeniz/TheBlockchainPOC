...
namespace TheBlockchainDB.Networks.Rules
{
   /// <summary>
   /// Checks if <see cref="TheBlockchainDBMain"/> network block's header has a valid block version.
   /// </summary>
   public class TheBlockchainDBHeaderVersionRule : HeaderVersionRule
   {
      /// <inheritdoc />
      ...
      public override void Run(RuleContext context)
      {
         ...
         // block versions above 7 and below 0x41281000.
